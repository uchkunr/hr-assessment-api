...
export class AssignmentTestService {
  ...
  async findAll(page: number = 1, limit: number = 10): Promise<AssignmentTestListResponseBO> {
  ...
  async update(id: string, data: UpdateAssignmentTestRequestBO): Promise<AssignmentTestBO> {
