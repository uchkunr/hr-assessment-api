  ...
  createRoutes() {
    return new Elysia({ prefix: '/assignment-test' })
      .post(
        ...
        async ({ body, status }) => {
          try {
            ...
            return status(400, {
              message: err instanceof Error ? err.message : 'Failed to create assignment test',
            });
          }
        },
        {
      ...
      .get(
        ...
        async ({ query, status }) => {
          try {
            ...
            const result = await this.assignmentTestService.findAll(page, limit);
            return {
              tests: result.tests,
              total: result.total,
              page: result.page,
            ...
            return status(500, {
              message: err instanceof Error ? err.message : 'Failed to fetch assignment tests',
            });
          }
        },
        {
      ...
      .get(
        ...
        async ({ params, status }) => {
          try {
            const assignmentTest = await this.assignmentTestService.findById(params.id);
            if (!assignmentTest) {
            ...
            return status(500, {
              message: err instanceof Error ? err.message : 'Failed to fetch assignment test',
            });
          }
        },
        {
      ...
      .put(
        ...
        async ({ params, body, status }) => {
          try {
            ...
            return status(400, {
              message: err instanceof Error ? err.message : 'Failed to update assignment test',
            });
          }
        },
        {
      ...
      .delete(
        ...
        async ({ params, status }) => {
          try {
            ...
            return status(400, {
              message: err instanceof Error ? err.message : 'Failed to delete assignment test',
            });
          }
        },
        {
