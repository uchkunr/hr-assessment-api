  ...
  createRoutes() {
    return new Elysia({ prefix: '/assignment-candidate' })
      .post(
        ...
        async ({ body, status }) => {
          try {
            ...
            return status(400, {
              message: err instanceof Error ? err.message : 'Failed to create assignment candidate',
            });
          }
        },
        {
      ...
      .get(
        ...
        async ({ query, status }) => {
          try {
            ...
            return status(500, {
              message: err instanceof Error ? err.message : 'Failed to fetch assignment candidates',
            });
          }
        },
        {
      ...
      .get(
        ...
        async ({ params, status }) => {
          try {
            const candidate = await this.assignmentCandidateService.findById(params.id);
            if (!candidate) {
            ...
            return status(500, {
              message: err instanceof Error ? err.message : 'Failed to fetch assignment candidate',
            });
          }
        },
        {
      ...
      .put(
        ...
        async ({ params, body, status }) => {
          try {
            return await this.assignmentCandidateService.update(params.id, body);
          } catch (err) {
            return status(400, {
              message: err instanceof Error ? err.message : 'Failed to update assignment candidate',
            });
          }
        },
        {
      ...
      .delete(
        ...
        async ({ params, status }) => {
          try {
            ...
            return status(400, {
              message: err instanceof Error ? err.message : 'Failed to delete assignment candidate',
            });
          }
        },
        {
