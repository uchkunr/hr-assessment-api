  ...
  createRoutes() {
    return new Elysia({ prefix: '/assignment-candidate-test' })
      .post(
        ...
        async ({ body, status }) => {
          try {
            ...
            return status(400, {
              message: err instanceof Error ? err.message : 'Failed to create test',
            });
          }
        },
        {
      ...
      .get(
        ...
        async ({ query, status }) => {
          try {
            ...
            const result = await this.assignmentCandidateTestService.findAll(page, limit);
            return {
              tests: result.tests,
              total: result.total,
              page: result.page,
            ...
            return status(500, {
              message: err instanceof Error ? err.message : 'Failed to fetch tests',
            });
          }
        },
        {
      ...
      .get(
        ...
        async ({ params, status }) => {
          try {
            const test = await this.assignmentCandidateTestService.findById(params.id);
            if (!test) {
            ...
            return status(500, {
              message: err instanceof Error ? err.message : 'Failed to fetch test',
            });
          }
        },
        {
      ...
      .put(
        ...
        async ({ params, body, status }) => {
          try {
            return await this.assignmentCandidateTestService.update(params.id, body);
          } catch (err) {
            return status(400, {
              message: err instanceof Error ? err.message : 'Failed to update test',
            });
          }
        },
        {
      ...
      .delete(
        ...
        async ({ params, status }) => {
          try {
            ...
            return status(400, {
              message: err instanceof Error ? err.message : 'Failed to delete test',
            });
          }
        },
        {
