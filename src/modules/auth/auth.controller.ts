      ...
      .post(
        ...
        async ({ body, jwt, status }) => {
          try {
            ...
            return status(
              400,
              this.handleAuthError(err, AUTH_CONSTANTS.ERROR_MESSAGES.REGISTRATION_FAILED),
            );
          }
        },
        {
      ...
      .post(
        ...
        async ({ body, jwt, status }) => {
          try {
            ...
            return status(
              401,
              this.handleAuthError(err, AUTH_CONSTANTS.ERROR_MESSAGES.LOGIN_FAILED),
            );
          }
        },
        {
      ...
      .get(
        ...
        async ({ status, store }) => {
          try {
            ...
            return status(
              401,
              this.handleAuthError(err, AUTH_CONSTANTS.ERROR_MESSAGES.AUTHENTICATION_FAILED),
            );
          }
        },
        {
